...
model.addAttribute("author", "Developed by: Miguel Ortiz");
...
model.addAttribute("subtitle", "Contact Us");
	...
	String desc = "Contáctenos a través de:<br>gmail:contactenos@contactos.es<br>número télefonico: 123-456-7890";
